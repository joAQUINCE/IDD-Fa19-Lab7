...
//----- EJC ------
var express1 = require('express'); // web server application
var app1 = express1(); // webapp
var http1 = require('http').Server('172.20.10.1'); // connects http library to server
var io1 = require('socket.io')(http1); // connect websocket library to server
var serverPort1 = 11123;
var SerialPort1 = require('serialport'); // serial library
var Readline1 = SerialPort1.parsers.Readline; // read serial data as lines
//----- EJC ------
